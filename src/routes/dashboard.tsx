      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 px-6 lg:px-10 py-8 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <button className="inline-flex items-center gap-2 h-11 px-5 rounded-lg bg-gradient-to-br from-brand to-brand-light text-brand-foreground font-semibold text-sm shadow-brand hover:scale-[1.02] active:scale-[0.99] transition-transform">
            ...
            <div className="bg-background rounded-2xl border border-border p-6 shadow-sm">
              ...
              <div className="space-y-4">
                {verifications.map((v) => (
                  <div
                    key={v.name}
                    className="p-4 rounded-xl bg-surface-muted/60"
                  >
                    ...
                    <div className="flex gap-2 mt-3">
                      <button className="flex-1 h-9 rounded-lg bg-brand text-brand-foreground text-xs font-bold hover:bg-brand-light transition-colors">
                        Approve
                      </button>
                      <button className="flex-1 h-9 rounded-lg border border-border text-foreground text-xs font-bold hover:bg-surface-muted transition-colors">
                        Reject
                      </button>
                    </div>
                  </div>
          ...
          <div className="bg-background rounded-2xl border border-border overflow-hidden shadow-sm">
            <div className="relative h-80 bg-gradient-to-br from-slate-200 to-slate-300">
              ...
              {/* Map pins */}
              <MapPin className="top-[40%] left-[30%]" color="bg-brand" />
              <MapPin className="top-[55%] left-[55%]" color="bg-orange-400" />
              <MapPin className="top-[35%] left-[70%]" color="bg-orange-400" />
              <MapPin className="top-[65%] left-[60%]" color="bg-brand" />
              <MapPin className="top-[70%] left-[72%]" color="bg-brand" />

              <div className="absolute bottom-5 right-5 flex flex-col gap-1 bg-background rounded-xl shadow-md overflow-hidden">
                <button className="size-10 hover:bg-surface-muted flex items-center justify-center transition-colors">
...
function MapPin({ className, color }: { className: string; color: string }) {
  return (
    <div className={`absolute ${className} -translate-x-1/2 -translate-y-full`}>
      <div className={`size-7 rounded-full ${color} shadow-lg flex items-center justify-center ring-4 ring-background/40`}>
        <span className="size-2.5 rounded-full bg-background/90" />
      </div>
    </div>
  );
}
